...
const PRACTICES = [
...

  {
    ...
    title: "Offense vs. defense (no goalie!), body position, shooting & passing",
    cancelled: "Cancelled due to weather. This plan moved to the next practice.",
    weather: { emoji: "⛈️", tempF: 96, condition: "Storms", humidity: 43 },
    summary:
      "Rescheduled from the previous rain-out — and cancelled again. This plan (offense/defense with no goalie, body position, shooting, and passing) moved to the next practice.",
